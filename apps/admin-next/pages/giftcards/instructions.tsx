...
import { filesAtom, logosAtom } from ".";
...
function Step1() {
  ...
  return (
    <div className="mb-8">
      ...
      <div className="mb-4 rounded border-2 border-yellow-400 p-4 mx-auto">
        <p>CSV Columns should be in this order (column names don't matter)</p>
        <div className="border bg-gray-100 p-2 flex justify-center text-center">
      ...
      <p className="text-xl text-gray-900">Keep this section blank to enter details manually</p>
      <hr className="my-12"></hr>
      <h2 className="mb-2 text-lg font-semibold">
