    ...
    <>
      ...
      <div className="bg-white text-center">
        <div className="mx-auto px-2 py-4 lg:items-center lg:justify-between lg:px-4">
          ...
          {emailSent && (
            <div className="text-dark-500 mt-12 text-left text-lg italic">
              The receipt for this transaction has been sent to{" "}
              <span className="text-blue-700">{donor.email_id}.</span>{" "}
            </div>
          )}
          <div className="mt-4 flex text-left lg:flex-shrink-0">
            <div className="flex-grow">
              You can view the progress of your trees on the dashboard.
            </div>
            <div className="ml-3">
              <Link href={`dashboard.14trees.org/ww/${donor.email_id}`}>
                <p className="whitespace-nowrap rounded-md border border-transparent bg-green-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-green-700">
                  Open Dashboard
                </p>
              </Link>
            </div>
