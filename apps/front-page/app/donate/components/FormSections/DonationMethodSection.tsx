...
interface DonationMethodSectionProps {
  treeLocation: string;
  setTreeLocation: (location: string) => void;
  donationMethod: string;
  setDonationMethod: (method: string) => void;
...
export const DonationMethodSection: React.FC<DonationMethodSectionProps> = ({
  treeLocation,
  setTreeLocation,
  donationMethod,
  setDonationMethod,
