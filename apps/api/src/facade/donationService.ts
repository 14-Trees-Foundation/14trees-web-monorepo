...
import { ContributionOption, Donation, DonationCreationAttributes, DonationMailStatus_Accounts, DonationMailStatus_AckSent, DonationMailStatus_BackOffice, DonationMailStatus_CSR, DonationMailStatus_DashboardsSent, DonationMailStatus_Volunteer, DonationStatus, DonationStatus_Paid } from "../models/donation";
...
export class DonationService {
    ...
    public static async createDonation(data: CreateDonationRequest): Promise<Donation> {
        ...
        const request: DonationCreationAttributes = {
            ...
            status: status || DonationStatus_Paid,
            tags: tags || null,
            rfr_id: rfr_id,
