...
// module.exports.getOverallOrgDashboard = async (req: Request, res: Response) => {
//   try {
...
// module.exports.getOverallPlotDashboard = async (req: any, res: any) => {
//   try {
//     if (!req.query.fromdate) {
//       throw new Error("Invalid from date!");
//     }
...
// module.exports.getBirthdayEvent = async (req: Request, res: Response) => {
...
// module.exports.addEvents = async (req: Request, res: Response) => {
...
// module.exports.removeEventAndUnassignTree = async (req: Request, res: Response) => {
//   const fields = req.body;
//   let saplingIds = fields.sapling_id.split(/[ ,]+/);
...
// module.exports.getEvents = async (req: Request, res: Response) => {
...
// module.exports.deleteEvent = async (req: Request, res: Response) => {
//   try {
...
// module.exports.addCorpEvent = async (req: Request, res: Response) => {
//   const fields = req.body;
...
//       tree_ids: tree_ids,
//       plot_id: new mongoose.Types.ObjectId(req.body.plot_id),
...
// module.exports.getCorpEvent = async (req: Request, res: Response) => {
//   const { offset, limit } = getOffsetAndLimitFromRequest(req);
...
// module.exports.updateCorpEvent = async (req: Request, res: Response) => {
//   try {
...
//       for (let i = 0; i < saplingIds.length; i++) {
//         let tree = await TreeModel.findOne({ sapling_id: saplingIds[i] });
//         (tree as any)._id.push(tree?._id);
//       }
//       event.tree_ids = fields.tree_ids;
//     }
//     if (fields.plot_id) event.plot_id = new mongoose.Types.ObjectId(req.body.plot_id);
...
// module.exports.deleteCorpEvent = async (req: Request, res: Response) => {
//   try {
