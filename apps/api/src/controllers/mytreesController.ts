...
// module.exports.createAlbum = async (req: any,res: any) => {
...
// module.exports.deleteAlbum = async (req: any,res: any) => {
//   try {
...
// module.exports.getAlbums = async (req: any,res: any) => {
//   let email = req.params["email"];
//   try {
...
// module.exports.getTrees = async (req: any,res: any) => {
...
// module.exports.updateTrees = async (req: any,res: any) => {
...
// module.exports.addTrees = async (req: any,res: any) => {
...
// module.exports.removeMappedToFromTrees = async (req: any,res: any) => {
//   const fields = req.body;
//   let saplingIds = fields.sapling_id.split(/[ ,]+/);
...
// module.exports.getUserTreeCount = async (req: any,res: any) => {
//   const {offset, limit} = getOffsetAndLimitFromRequest(req);
//   try {
