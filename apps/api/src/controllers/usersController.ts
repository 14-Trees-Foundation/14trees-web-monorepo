...
// import { UserModel, User }  from "../models/user"; // Assuming User model is defined here
...
// import { createObjectCsvWriter } from 'csv-writer'; // Import specific function
// import * as fs from 'fs'; // Import all members from fs
...
// module.exports.addUsersBulk = async (req: any,res: any) => {
...
// module.exports.getUsersByEmailIdPrefix = async (req: any,res: any) => {
//   try {
