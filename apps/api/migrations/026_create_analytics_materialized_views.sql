...
CREATE MATERIALIZED VIEW IF NOT EXISTS "14trees".mv_gift_card_request_summary AS
SELECT
...
LEFT JOIN "14trees".users u ON u.id = gcr.created_by
...
REFRESH MATERIALIZED VIEW "14trees".mv_gift_card_request_summary;

CREATE MATERIALIZED VIEW IF NOT EXISTS "14trees".mv_requester_leaderboard AS
SELECT
...
REFRESH MATERIALIZED VIEW "14trees".mv_requester_leaderboard;
